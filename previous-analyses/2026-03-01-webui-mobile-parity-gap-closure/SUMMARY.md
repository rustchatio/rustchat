...
- Date: 2026-03-01
- Status: Backend/mobile wire-contract gaps are closed and verified; Notifications/Calls settings parity pass is implemented and compiled.
...
- Screenshot-level visual verification is still manual (no automated screenshot regression gate in CI yet).
