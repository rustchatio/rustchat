...
<template>
 ...
 class="flex items-center px-4 py-2 text-sm font-medium text-danger border border-red-300 rounded-lg hover:bg-red-50 :bg-red-900/20 transition-colors disabled:opacity-50"
 >
