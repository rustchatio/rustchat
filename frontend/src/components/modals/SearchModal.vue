...
<template>
 ...
 <button @click="handleClose" class="p-1 hover:bg-gray-100 :bg-gray-700 rounded">
 ...
 class="px-4 py-3 hover:bg-gray-50 :bg-gray-700/50 cursor-pointer border-b border-gray-100 last:border-0"
 >
 ...
 class="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 :bg-gray-700 rounded-lg"
 >
