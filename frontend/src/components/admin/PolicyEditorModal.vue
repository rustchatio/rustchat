...
<template>
 ...
 :key="group.id"
 class="flex items-center p-2 hover:bg-gray-50 :bg-gray-700 rounded cursor-pointer"
 >
 <input
 type="checkbox"
 :value="group.id"
 ...
 :key="role"
 class="flex items-center px-3 py-2 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 :bg-gray-700"
 ...
 <button
 @click="previewImpact"
 class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 :bg-gray-700 rounded-lg transition-colors"
 >
 ...
 <button
 @click="cancel"
 class="px-4 py-2 text-gray-700 hover:bg-gray-100 :bg-gray-700 rounded-lg transition-colors"
 >
 Cancel
 </button>
 <button
