...
<template>
 ...
 <button 
 @click="$emit('close')"
 class="p-1 hover:bg-gray-100 :bg-gray-700 rounded transition-colors"
 >
 ...
 :key="message.id"
 class="px-4 py-4 hover:bg-gray-50 :bg-gray-800/50 transition-colors group relative"
 >
 ...
 class="p-1 hover:bg-gray-200 :bg-gray-700 rounded text-gray-400 hover:text-red-500 transition-colors"
 title="Unsave"
 >
 ...
 class="p-1 hover:bg-gray-200 :bg-gray-700 rounded text-gray-400 hover:text-blue-500 transition-colors"
