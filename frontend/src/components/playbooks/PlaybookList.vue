...
<template>
 ...
 class="flex flex-col items-center justify-center p-8 border-2 border-dashed border-gray-300 rounded-xl hover:border-indigo-500 hover:bg-gray-50 :bg-gray-800 transition-all group"
 >
