...
<template>
 ...
 :class="{ 'cursor-pointer hover:border-indigo-400 :border-indigo-500': isImage(file.mime_type) }"
 @click="handlePreview"
 >
 ...
 download 
 @click.stop
 class="p-1.5 hover:bg-gray-100 :bg-gray-700 rounded-lg text-gray-500 hover:text-indigo-600 :text-indigo-400 transition-colors"
 >
