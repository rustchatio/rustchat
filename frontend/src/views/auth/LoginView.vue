...
<template>
 ...
 class="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 :bg-gray-800 transition-colors text-gray-700 font-medium"
 >
