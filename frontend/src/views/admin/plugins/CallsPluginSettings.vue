...
<template>
 ...
 class="px-3 py-2 text-red-600 hover:bg-red-50 :bg-red-900/20 rounded-lg"
 >
 Remove
 </button>
 </div>
 ...
 <button
 @click="addStunServer"
 class="px-4 py-2 bg-gray-200 hover:bg-gray-300 :bg-gray-600 rounded-lg text-sm font-medium"
 >
 Add Server
 </button>
 </div>
 ...
 :disabled="testing"
 class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 :bg-slate-600 focus:outline-none"
 >
