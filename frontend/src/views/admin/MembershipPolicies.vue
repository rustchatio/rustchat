...
<template>
 ...
 <button
 @click="fetchPolicies"
 class="flex items-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 :bg-gray-700 transition-colors"
 >
 ...
 :key="policy.id"
 class="p-6 hover:bg-gray-50 :bg-gray-750 transition-colors"
 >
