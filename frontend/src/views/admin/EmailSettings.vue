...
<template>
 ...
 class="p-2 text-gray-500 hover:text-indigo-600 hover:bg-indigo-50 :bg-indigo-900/30 rounded-lg"
 ...
 class="p-2 text-red-500 hover:text-red-700 hover:bg-red-50 :bg-red-900/30 rounded-lg">
 ...
 <button @click="showAddModal = false" class="px-4 py-2 text-gray-700 hover:bg-gray-100 :bg-slate-700 rounded-lg">
 Cancel
 </button>
